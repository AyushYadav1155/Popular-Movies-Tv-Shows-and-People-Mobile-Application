...
import com.example.tmdb_project.presentation.di.core.AppComponent
import com.example.tmdb_project.presentation.di.core.AppModule
import com.example.tmdb_project.presentation.di.core.DaggerAppComponent
import com.example.tmdb_project.presentation.di.core.NetModule
import com.example.tmdb_project.presentation.di.core.RemoteDataModule
...
class App:Application(),Injector {
    ...
    override fun onCreate() {
        ...
        appComponent = DaggerAppComponent.builder()
            .appModule(AppModule(applicationContext)).netModule(NetModule(BuildConfig.BASE_URL))
